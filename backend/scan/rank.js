...
/**
 * Scan module: query the Tranco ranking API for the target domain.
 * Honours `TRANCO_API_KEY` / `TRANCO_USERNAME` for HTTP basic auth (P0-1).
 *
 * @param {string} url Normalised target URL.
 * @returns {Promise<{ranks?: Array, error?: string, skipped?: string}>}
 */
